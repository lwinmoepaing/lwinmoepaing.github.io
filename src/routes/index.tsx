      ...
      <div class="max-wrapper px-4 sm:px-8">
        ...
        <div class="max-w-[500px] mx-auto my-[1rem] text-center">
          ...
          <h2 class="text-lg my-2">
            🤝 I’m <span class="text-indigo-500 font-bold">Frontend Developer</span>, and looking for help with
            Javascript Language to build Many Free Softwares to help people who
            can't afford to pay !
          </h2>
        </div>
      </div>
